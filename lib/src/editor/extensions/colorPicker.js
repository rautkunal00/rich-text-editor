...
function createColorPicker(container, onChange) {
...
export function createColorPickerWithPalette(button, onChange, toolbar) {
    ...
    button.addEventListener('click', (event) => {
        if (isColorpaletteOpen) {
            ...
            colorContainer === null || colorContainer === void 0 ? void 0 : colorContainer.remove();
        }
        else {
